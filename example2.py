...
# set up Hamiltonian
H1=hamiltonian(static_1,dynamic,basis=basis,dtype=np.float64, check_symm=False)
H2=hamiltonian(static_2,dynamic,basis=basis,dtype=np.float64, check_symm=False)
